...
Route::get('/caderneta-poupanca/json', [IndicesJsonController::class, 'indiceCadernetaPoupanca'])->name('caderneta-poupanca/json');
...
Route::get('/ipc-fipe/json', [IndicesJsonController::class, 'indiceIpcFipe'])->name('ipc-fipe/json');
